ADD HOSTS "127.0.0.1":9779,"127.0.0.1":9779,"127.0.0.1":9779
...
CREATE EDGE IF NOT EXISTS user_region_relation(
	`id` INT32 NOT NULL COMMENT '主键', \ 
...
CREATE EDGE IF NOT EXISTS region_region_relation(
	`id` INT32 NOT NULL COMMENT '主键', \ 
	`region_id` FIXED_STRING(64) DEFAULT NULL COMMENT '', \ 
	`parent_region_id` FIXED_STRING(64) DEFAULT NULL COMMENT '', \ 
	`region_code` FIXED_STRING(64) DEFAULT NULL COMMENT '地址编码', \ 
...
CREATE EDGE IF NOT EXISTS user_user_relation(
	`id` INT32 NOT NULL COMMENT '主键', \ 
